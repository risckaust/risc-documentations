...
## Bash script for setting up ROS Kinetic (with Gazebo) development environment for PX4
## It installs the common dependencies for all targets (including Qt Creator)
##
## Installs:
## - Common dependencies libraries and tools as defined in `ubuntu_sim_common_deps.sh`
## - ROS Kinetic (including Gazebo9)
## - MAVROS
...
common_deps=$(wget https://raw.githubusercontent.com/risckaust/risc-documentations/master/src/initial_settings/ubuntu_sim_common_deps.sh -O -)
wget_return_code=$?
