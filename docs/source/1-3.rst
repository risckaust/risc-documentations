...
.. image:: ../_static/brushless_motors.jpg
   :scale: 50 %
   :align: center
...
* Remote control receiver. A remote control (RC) radio system is required if you want to manually control your vehicle. Choose either SPKT/DSM (Spektrum) or PPM-Sum and S.BUS (FrSky) receivers depending on the flight controller you've.
