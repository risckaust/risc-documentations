...
Copy the code from `here <https://github.com/risckaust/risc-documentations/blob/master/src/SITL-simulator/setpoints_node.py>`_ to the ``setpoints_node.py`` file
...
Then, copy the content from `here <https://github.com/risckaust/risc-documentations/blob/master/src/SITL-simulator/joystick_flight.launch>`_ to the launch file.
